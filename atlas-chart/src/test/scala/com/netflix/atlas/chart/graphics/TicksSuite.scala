...
class TicksSuite extends FunSuite {
  ...
  test("duration [0, 60]") {
    ...
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.0s")
    assertEquals(ticks.last.label, "1.0min")
  }
  ...
  test("duration [0, 3659]") {
    ...
    assertEquals(ticks.count(_.major), 6)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.0min")
    assertEquals(ticks.last.label, "1.000hr")
  }
  ...
  test("duration [0, 86400]") {
    ...
    assertEquals(ticks.count(_.major), 7)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.0hr")
    assertEquals(ticks.last.label, "1.000day")
  }
  ...
  test("duration [0, 2592000]") {
    ...
    assertEquals(ticks.count(_.major), 6)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.0day")
    assertEquals(ticks.last.label, "1.000mon")
  }
  ...
  test("duration [0, 31536000]") {
    ...
    assertEquals(ticks.count(_.major), 7)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.000mon")
  ...
  test("duration [339.86152734763687, 339.87716933873867]") {
    ...
    assertEquals(ticks.head.label, "2.0ms")
    assertEquals(ticks.last.label, "17.0ms")
  }
  ...
  test("duration [59, 61]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "59.0s")
    assertEquals(ticks.last.label, "1.015min")
  }
  ...
  test("duration [59, 3605]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "3.0min")
    assertEquals(ticks.last.label, "1.000hr")
  }
  ...
  test("duration [0, 3153600000]") {
    ...
    assertEquals(ticks.count(_.major), 4)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "0.000yr")
    assertEquals(ticks.last.label, "95.129yr")
  }
  ...
  test("duration [0.01, 1]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "50.0ms")
  ...
  test("duration [1.0e-10, 1.0e-9]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "150.000ps")
    assertEquals(ticks.last.label, "1000.000ps")
  }
  ...
  test("duration [1.0e-12, 1.0e-9]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "50.000ps")
    assertEquals(ticks.last.label, "1000.000ps")
  }
  ...
  test("duration [1.0e-12, 1.0e12]") {
    ...
    assertEquals(ticks.count(_.major), 5)
    assertEquals(ticks.head.offset, 0.0)
    assertEquals(ticks.head.label, "1585.490yr")
    assertEquals(ticks.last.label, "31709.792yr")
  }
